...
const mustHaveValidId = 'Instance must has a valid id to perform this operation.';
 ...
 * Youtube resources filtered and modeled by predefined properties.
 *
...
function nextChunk(max, cb, err) {
    ...
    // nextChunk is polymorphism as well as fetch()
...
function settingsToRequestParams() {
    ...
    // merged and also adapted so `querystring' can convert them into a
...
function getTotalResults() {
    return (typeof this._totalResults != 'undefined') ? this._totalResults : -1;
};
...
module.exports = {
    ...
    'mustHaveValidId': mustHaveValidId
};
