...
const Resource = {
    ...
    // elementCreator should be overriden by inherited resources.
...
function fetch(arg1, arg2, arg3) {
    ...
    this.sendRequest(params, cb, err);
...
function sendRequest(params, cb=Function.prototype, err=Function.prototype) {
...
function onResolveRequest(body, cb) {
    ...
    body.items.forEach((item) => {
        this.push(this.elementCreator(item));
    });
